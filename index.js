...
// Endpoint to handle form submission from page.js
app.post('/submit-booking-form', (req, res) => {
  const { tourTitle, tourUrl, name, email, phone, package, travelers, startDate, endDate, requirements } = req.body;
  ...
  const ownerMailOptions = {
    ...
    html: `
      <div style="font-family: Arial, sans-serif; line-height: 1.6; color: #333;">
        <h2 style="color: #4CAF50;">New Booking Request Received</h2>
        <p>Dear Upepo Travels Team,</p>
        <p>You have received a new booking request. Here are the details:</p>
        <table style="width: 100%; border-collapse: collapse;">
          <tr>
            <td style="padding: 8px; border: 1px solid #ddd;">Tour Title:</td>
            <td style="padding: 8px; border: 1px solid #ddd;">${tourTitle}</td>
          </tr>
          <tr>
            <td style="padding: 8px; border: 1px solid #ddd;">Tour URL:</td>
            <td style="padding: 8px; border: 1px solid #ddd;">${tourUrl}</td>
          </tr>
          <tr>
            <td style="padding: 8px; border: 1px solid #ddd;">Full Name:</td>
            <td style="padding: 8px; border: 1px solid #ddd;">${name}</td>
          ...
          <tr>
            <td style="padding: 8px; border: 1px solid #ddd;">Number of Travelers:</td>
          ...
          <tr>
            <td style="padding: 8px; border: 1px solid #ddd;">Special Requirements:</td>
  ...
  const clientMailOptions = {
    ...
    html: `
      <div style="font-family: Arial, sans-serif; line-height: 1.6; color: #333;">
        <h2 style="color: #4CAF50;">Thank you for your submission!</h2>
        <p>Dear Customer,</p>
        <p>We have received your booking request. Here are the details you provided:</p>
        <table style="width: 100%; border-collapse: collapse;">
          <tr>
            <td style="padding: 8px; border: 1px solid #ddd;">Tour Title:</td>
            <td style="padding: 8px; border: 1px solid #ddd;">${tourTitle}</td>
